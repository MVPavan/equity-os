...
| `docs/research/three-source-first-measurement.md` | **Before trusting a three-source line or grading its tier.** Part 1: XBRL↔Screener over nine stocks — 32/36 AGREE, the four tier-3 anomalies (three EPS, one revenue) hand-read, the net-profit candidate decided by replay (`ProfitLossForPeriod`, not owners-of-parent), and the expander-row reader defect the replay exposed. Part 2 (Tijori) pending the manual acquisition |
