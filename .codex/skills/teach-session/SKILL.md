...
Quiz the learner with open-ended or multiple-choice questions using the active user-input surface when available, or ask directly in chat. Vary answer order and do not reveal answers before submission. Show code or have the learner use a debugger when useful.

The session should not end until you've verified that the human has demonstrated that learner understood everything on your list.
