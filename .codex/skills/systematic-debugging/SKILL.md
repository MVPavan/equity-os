...
- If the issue crosses multiple systems or one hypothesis already failed, dispatch a native read-only subagent to falsify the current hypothesis independently.
