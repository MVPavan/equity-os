...
The goal prohibits product implementation until the specification program has clean delegated approval ([goal:645](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:645), [goal:673](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:673), [goal:730](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:730)). Each target nevertheless requires behavioral proof before its initial delegated artifact approval:

- S10 requires sealed-package reconstruction, rejected writes, correction/deletion behavior, and workflow resumption proof ([S10:183](/data/codes/equity-os/docs/specs/equity-os-s10-source-of-truth-evidence-retention.md:183)).
- S11 requires executable adapter, retrieval, gateway, manifest, and replay behavior ([S11:200](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:200)).
- S12 requires identity, migration, canonical-switch, and cutoff behavior to be proved ([S12:291](/data/codes/equity-os/docs/specs/equity-os-s12-observation-fact-identity-schema.md:291)).
...
- `EvidencePackageManifest.manifest_sha256` ([S10:86](/data/codes/equity-os/docs/specs/equity-os-s10-source-of-truth-evidence-retention.md:86), [S10:101](/data/codes/equity-os/docs/specs/equity-os-s10-source-of-truth-evidence-retention.md:101))
- `RunManifest.manifest_sha256` ([S11:84](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:84), [S11:105](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:105))
...
S10 defines `evidence_package_id` as stable across monotonically increasing versions, but `parent_package_id` names only an ID ([S10:90](/data/codes/equity-os/docs/specs/equity-os-s10-source-of-truth-evidence-retention.md:90), [S10:99](/data/codes/equity-os/docs/specs/equity-os-s10-source-of-truth-evidence-retention.md:99)). It therefore cannot identify which immutable version is the parent and may simply point back to the same version family.

This conflicts with S11’s exact package binding by ID, version, and hash ([S11:94](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:94)). Parentage needs an exact version/hash reference.
...
A run can have multiple attempts ([S11:78](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:78)), but `RunManifest` contains a singular evidence-package binding described as belonging “to the attempt” ([S11:94](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:94)). `AttemptManifest` then adds package version again ([S11:107](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:107)).

Additionally, approval and published-artifact fields begin empty and are later populated ([S11:101](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:101)), while changing a manifest hash in place is forbidden ([S11:168](/data/codes/equity-os/docs/specs/equity-os-s11-run-manifest-cutoff-reproducibility.md:168)). The contract does not define immutable manifest versions or append-only events that resolve these transitions.
...
The scope promises separation of “source occurrence” and “observation” ([S12:43](/data/codes/equity-os/docs/specs/equity-os-s12-observation-fact-identity-schema.md:43)), while the identity table merges them into one `Source occurrence / observation` concept and one `observation_id` ([S12:69](/data/codes/equity-os/docs/specs/equity-os-s12-observation-fact-identity-schema.md:69)). The terminology should consistently declare whether these are synonyms or separate lifecycle objects.
