...
1. **S07-I1 — Known-case outcome schema cannot represent the required edit/defer cases.**
   **Load-bearing:** Yes.
   ...
   Locations: [S07:114](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:114), [S07:121](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:121), [S07:197](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:197), [disposition:216](/data/codes/equity-os/docs/blueprint/funda-third-order-review-disposition-report.md:216).
...
2. **S07-I2 — Promotion policy conflicts for real-source golden fixtures.**
   **Load-bearing:** Yes.
   ...
   Locations: [S07:75](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:75), [S07:87](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:87), [S07:143](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:143), [S07:161](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:161).
...
3. **S07-I3 — A-08’s owner/location/cadence contract lacks a machine-readable interface and explicit acceptance assertion.**
   **Load-bearing:** Yes.
   ...
   Locations: [S07:23](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:23), [S07:69](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:69), [S07:175](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:175), [S07:186](/data/codes/equity-os/docs/specs/equity-os-s07-golden-set-failure-reviewer-controls.md:186).
...
1. **S08-I1 — `MetricObservation` cannot implement its declared append-only supersession semantics.**
   **Load-bearing:** Yes.
   ...
   Location: [S08:134](/data/codes/equity-os/docs/specs/equity-os-s08-success-metrics-budgets-capacity.md:134).
...
2. **S08-I2 — A-07’s permitted measurement-rule path is incorrectly forced through `BUDGET_APPROVAL`.**
   **Load-bearing:** Yes.
   ...
   Locations: [S08:22](/data/codes/equity-os/docs/specs/equity-os-s08-success-metrics-budgets-capacity.md:22), [S08:116](/data/codes/equity-os/docs/specs/equity-os-s08-success-metrics-budgets-capacity.md:116), [S08:186](/data/codes/equity-os/docs/specs/equity-os-s08-success-metrics-budgets-capacity.md:186).
...
3. **S08-I3 — Phase-gate threshold applicability is overbroad and mechanically undefined.**
   **Load-bearing:** Yes.
   ...
   Locations: [S08:79](/data/codes/equity-os/docs/specs/equity-os-s08-success-metrics-budgets-capacity.md:79), [S08:150](/data/codes/equity-os/docs/specs/equity-os-s08-success-metrics-budgets-capacity.md:150), [register-v2:124](/data/codes/equity-os/docs/blueprint/funda-blueprint-implementation-decision-register-v2.md:124).
...
1. **S09-I1 — C-14 invokes the wrong reconciliation class for a status-only activation.**
   **Load-bearing:** Yes.
   ...
   Locations: [S09:197](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:197), [S09:206](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:206), [goal:622](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:622), [goal:629](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:629).
...
2. **S09-I2 — The typed C-14 predicate cannot mechanically enforce rights validity or official-source status.**
   **Load-bearing:** Yes.
   ...
   Locations: [S09:182](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:182), [S09:190](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:190), [goal:270](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:270), [goal:299](/data/codes/equity-os/docs/goals/equity-os-blueprint-completion.md:299).
...
3. **S09-I3 — Provider authorization uses an untyped “where applicable” escape.**
   **Load-bearing:** Yes.
   ...
   Locations: [S09:95](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:95), [S09:218](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:218), [S09:225](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:225).
...
4. **S09-I4 — B-09 requires S17-owned identities despite declaring only A-05 as its dependency.**
   **Load-bearing:** Yes.
   ...
   Locations: [S09:113](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:113), [S09:152](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:152), [S09:274](/data/codes/equity-os/docs/specs/equity-os-s09-filing-ingestion-point-in-time-capture.md:274).
