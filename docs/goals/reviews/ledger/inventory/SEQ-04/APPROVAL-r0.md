# Inventory review — SEQ-04 / APPROVAL / r0
...
```json
{"approval_records":[],"human_review_id":["HR-0001","HR-0004"],"required_approvals":[{"actor":null,"approval_id":"APR-SEQ-04-01","approval_type":"DELEGATED_ARTIFACT_APPROVAL","evidence_ref_ids":[],"matched_record_id":null,"required_authority":"Delegated fresh Sol xhigh specification reviewer","scope":"SEQ-04 under S06","status":"UNRESOLVED","timestamp":null}],"security_exception_ids":[]}
```
...
- `reviewed_inventory_sha256` (pre-record): `9edd9d8114cf22386b3a5f36902227e2f158215f0e7a1ccab7bab5942d155377`
...
`APR-SEQ-04-01` is correctly typed `DELEGATED_ARTIFACT_APPROVAL` with the single
...
|---|---|
| `S06` | `APR-SEQ-04-01`, `DELEGATED_ARTIFACT_APPROVAL`, scope `"SEQ-04 under S06"` |
| `S08` | **none** |
