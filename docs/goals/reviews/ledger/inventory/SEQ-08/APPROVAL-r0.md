# Inventory review — SEQ-08 / APPROVAL / r0
...
```json
{"approval_records":[],"human_review_id":["HR-0004"],"required_approvals":[{"actor":null,"approval_id":"APR-SEQ-08-01","approval_type":"DELEGATED_ARTIFACT_APPROVAL","evidence_ref_ids":[],"matched_record_id":null,"required_authority":"Delegated fresh Sol xhigh specification reviewer","scope":"SEQ-08 under S12","status":"UNRESOLVED","timestamp":null}],"security_exception_ids":[]}
```
...
- `reviewed_inventory_sha256` (pre-record): `b2a8214ddadaf3abd9a2d4590557ab2c4b455828dd7b93ea00dafe2db930260f`
...
`APR-SEQ-08-01` is correctly typed `DELEGATED_ARTIFACT_APPROVAL` with the single
...
|---|---|
| `S12` | `APR-SEQ-08-01`, `DELEGATED_ARTIFACT_APPROVAL`, scope `"SEQ-08 under S12"` |
| `S13` | **none** |
