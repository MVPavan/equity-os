# Inventory review — SEQ-03 / APPROVAL / r0
...
```json
{"approval_records":[],"human_review_id":["HR-0004"],"required_approvals":[{"actor":null,"approval_id":"APR-SEQ-03-01","approval_type":"DELEGATED_ARTIFACT_APPROVAL","evidence_ref_ids":[],"matched_record_id":null,"required_authority":"Delegated fresh Sol xhigh specification reviewer","scope":"SEQ-03 under S05","status":"UNRESOLVED","timestamp":null}],"security_exception_ids":[]}
```
...
- `reviewed_inventory_sha256` (pre-record): `6b0ce3f0a4211ae250d0b751a92af35b9cab2c6cc5eb9cc1eb74be477cf34f48`
...
`APR-SEQ-03-01` is correctly typed `DELEGATED_ARTIFACT_APPROVAL` with the single
...
|---|---|
| `S05` | `APR-SEQ-03-01`, `DELEGATED_ARTIFACT_APPROVAL`, scope `"SEQ-03 under S05"` |
| `S09` | **none** |
